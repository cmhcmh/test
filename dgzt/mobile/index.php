...
@$gd = $_POST['gd'];
@$code = $_POST['code'];
@$content = '东莞活动手机版33.26-4.22'.$_POST['content'];
		...
		<div style="width:100%;">
			<div style="margin:0px auto;background:url(images/hz033.png) no-repeat center top; background-size:100%;width:90%;  height:100%;">
				<ul style="width:100%; display:block; padding-top:9%; padding-bottom:5%;padding-left:2%;">
					<a href="http://dg.hxdec.com/mobile.php/Case/index/style_id/4/layout_id/0/acreage_id/0"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal05.jpg" style="width:98%;"/></li></a>
					<a href="http://dg.hxdec.com/mobile.php/Case/index/style_id/1/layout_id/0/acreage_id/0"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal03.jpg" style="width:98%;"/></li></a>
					<div class="clear"></div>
					<a href="http://dg.hxdec.com/mobile.php/Case/index/style_id/51/layout_id/0/acreage_id/0"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal12.jpg" style="width:98%;"/></li></a>
					<a href="http://dg.hxdec.com/mobile.php/Case/index/style_id/2/layout_id/0/acreage_id/0"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal09.jpg" style="width:98%;"/></li></a>
					<div class="clear"></div>
				</ul>
			</div>
		</div>
