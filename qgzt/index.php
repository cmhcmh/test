...
@$gd = $_POST['gd'];
@$code = $_POST['code'];
@$content = '全国活动3.26-4.22'.$_POST['content'];
...
<body style="background:#F63F3B;" >
            ...
            document.searchmyform.submit();     
				...
				<ul class="menu clearfix">
					...
					<li>
						...
						<dl>
						<dd><a href="http://www.hxdec.com//ppsl/index.php ">品牌介绍</a></dd><dd><a href="http://www.hxdec.com/index.php/News/index/cat_id/9 ">发展历程</a></dd><dd><a href="http://www.hxdec.com/index.php/News/index/cat_id/10 ">资质荣誉</a></dd><dd><a href="http://www.hxdec.com/index.php/News/index/cat_id/11 ">企业动态</a></dd><dd><a href="http://www.hxdec.com/index.php/News/index/cat_id/12 ">社会公益</a></dd><dd><a href="http://www.hxdec.com/index.php/News/index/cat_id/13 ">品牌视频</a></dd>						</dl>
					</li>
					<li>
						<h3><a href="http://www.hxdec.com/index.php/Case/index">装修案例</a></h3>
						<dl>

							<dd><a href="" target="_blank">金马克</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/Case/index">精品案例</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/Gallery/index">案例图库</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/Vr/index">VR实景</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/Hourse/index">热装楼盘</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/Work/index">在建工地</a></dd>
						</dl>
					</li>
					<li>
						<h3><a href="http://www.hxdec.com/index.php/Design/index">服务团队</a></h3>
						<dl>
							<dd style="display: none"><a href="#">设计研究院</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/Design/index">设计团队</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/Dot/index">服务门店</a></dd>
						</dl>
					</li>
					<li>
						<h3><a href="http://www.hxdec.com/index.php/Page/index/cat_id/30">服务保障</a></h3>
						<dl>
							<dd><a href="http://www.hxdec.com//index.php/Page/index/cat_id/30">服务流程</a></dd>
							<dd><a href="#" class="boOrder">在线下单</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/Design/index"  >装修预约</a></dd>
							<dd><a href="http://www.hxdec.com/index.php/News/index/cat_id/34">装修故事</a></dd>
						</dl>
					</li>
	...
	<div class="main" style="width: 100%;margin: 0px auto;text-align: center;">
		...
		<div style="width:1201px;margin: 0px auto;text-align: center;">
			<ul style="padding-top:2%;">
				...
				<li style="float:left;background:url(images/HZ2_12.png) no-repeat center top; background-size:95%;width:50%; height:409px;">
					<!--<p style="font-size:21.23px;color:#fff;width:551px;line-height:45px;text-align:left; position: relative; top:65%;left:8%;">春装会下定客户享受基础工程直接费9折优惠 <br/>(不含999元/m²口碑理想整装客户)</p>-->
				</li>
					  ...
					  <div class="swiper-slide"> 
					   <ul id="Tab">
						  <li>
							<ul id="Tab_c">
								<li>
									<a href="http://www.hxdec.com/index.php/Case/index/style_id/2/layout_id/0/acreage_id/0" target="_blank">
									...
									<div class="clear"></div>
									<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">新中式</div>
									</a>
								</li>
								<li>
									<a href="http://www.hxdec.com/index.php/Case/index/style_id/4/layout_id/0/acreage_id/0" target="_blank">
									...
									<div class="clear"></div>
									<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">欧式</div>
									</a>
								</li>
								<li>
									<a href="http://www.hxdec.com/index.php/Case/index/style_id/1/layout_id/0/acreage_id/0" target="_blank">
							...
							<ul id="Tab">
							  <li>
								<ul id="Tab_c">
									<li>
										<a href="http://www.hxdec.com/index.php/Case/index/style_id/6/layout_id/0/acreage_id/0" target="_blank">
									...
									<p><img src="images/al/2-1 (3).png" style="width: 110px;height:104px;"/></p>
										<div class="clear"></div>
										<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">混搭</div>
										</a>
									</li>
									<li>
										<a href="http://www.hxdec.com/index.php/Case/index/style_id/51/layout_id/0/acreage_id/0" target="_blank">
									...
									<p><img src="images/al/2-2 (3).png" style="width: 110px;height:104px;"/></p>
										<div class="clear"></div>
										<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">美式</div>
										</a>
									</li>
									<li>
										<a href="http://www.hxdec.com/index.php/Case/index/style_id/73/layout_id/0/acreage_id/0" target="_blank">
									...
									<p><img src="images/al/2-3 (3).jpg" style="width: 110px;height:104px;"/></p>
										<div class="clear"></div>
										<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">法式</div>
										</a>
									</li>
								</ul>
							  </li>
							...
							<div class="swiper-slide">  <ul id="Tab">
							  <li>
								<ul id="Tab_c">
									<li>
										<a href="http://www.hxdec.com/index.php/Case/index/style_id/77/layout_id/0/acreage_id/0" target="_blank">
									...
									<p><img src="images/al/3-1 (3).png" style="width: 110px;height:104px;"/></p>
										<div class="clear"></div>
										<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">简欧</div>
										</a>
									</li>
									<li>
										<a href="http://www.hxdec.com/index.php/Case/index/style_id/87/layout_id/0/acreage_id/0" target="_blank">
									...
									<p><img src="images/al/3-2 (3).png" style="width: 110px;height:104px;"/></p>
										<div class="clear"></div>
										<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">北欧</div>
										</a>
									</li>
									<li>
										<a href="http://www.hxdec.com/index.php/Case/index/style_id/81/layout_id/0/acreage_id/0" target="_blank">
		...
		<div style="background:url(images/HZ2_055553.png) no-repeat center top; margin:0px auto; width:1201px; height:528px; margin-top:74px;margin-bottom:314px;position:relative; z-index:9;">
			<div class="left"style="margin-top: 2%; margin-left: 2%;width:800px;float:left;">
				<ul >
					<a target="_blank" href="http://www.hxdec.com/index.php/Design/detail/id/429"><li style="float:left;margin-right:2%;"><img src="images/全国站_11.png"/></li></a>
					<a target="_blank" href="http://www.hxdec.com/index.php/Design/detail/id/475"><li style="float:left;margin-right:2%;"><img src="images/全国站_13.png"/></li></a>
					<a target="_blank" href="http://www.hxdec.com/index.php/Design/detail/id/3547"><li style="float:left;margin-right:2%;"><img src="images/全国站_15.png"/></li></a>
					<a target="_blank" href="http://www.hxdec.com/index.php/Design/detail/id/1014"><li style="float:left;margin-right:2%;"><img src="images/全国站_17.png"/></li></a>
					<div class="clear"></div>
				</ul>
				<ul style="margin-top:2%;">
					<a target="_blank" href="http://www.hxdec.com/index.php/Design/detail/id/1689"><li style="float:left;margin-right:2%;"><img src="images/全国站_29.png"/></li></a>
					<a target="_blank" href="http://www.hxdec.com/index.php/Design/detail/id/1303"><li style="float:left;margin-right:2%;"><img src="images/全国站_31.png"/></li></a>
					<a target="_blank" href="http://www.hxdec.com/index.php/Design/detail/id/2622"><li style="float:left;margin-right:2%;"><img src="images/全国站_33.png"/></li></a>
					<a target="_blank" href="http://www.hxdec.com/index.php/Design/detail/id/428"><li style="float:left;margin-right:2%;"><img src="images/全国站_35.png"/></li></a>
					<div class="clear"></div>
				</ul>
	...
	<div style="position:absolute; bottom:400px;z-index:4;text-align:center; margin:0px auto;width: 100%;"><p style="margin:0px auto;text-align:center;margin: 0 auto;width: 1200px;font-size:20px;">本次活动最终解释权归 广东华浔品味装饰集团 所有</p></div>
...
<div class="foot">
		<div class="layout">
			<div class="ftop clearfix">
				...
				<dl class="clearfix">
					<dt><h3>装修案例</h3></dt>
							<dd><a href="http://www.hxdec.com//index.php/Case/index"  target="_blank">金马克</a></dd>
							<dd><a href="http://www.hxdec.com//index.php/Case/index"  target="_blank">精品案例</a></dd>
							<dd><a href="http://www.hxdec.com//index.php/Gallery/index"  target="_blank">案例图库</a></dd>
							<dd><a href="http://www.hxdec.com//index.php/Vr/index"  target="_blank">VR实景</a></dd>
							<dd><a href="http://www.hxdec.com//index.php/Hourse/index"  target="_blank">热装楼盘</a></dd>
							<dd><a href="http://www.hxdec.com//index.php/Work/index"  target="_blank">在建工地</a></dd>
				</dl>

				<dl class="clearfix">
					<dt><h3>服务团队</h3></dt>
						<dd><a href="http://www.hxdec.com//index.php/Design/index"  target="_blank">设计团队</a></dd>
						<dd><a href="http://www.hxdec.com//index.php/Dot/index"  target="_blank">服务门店</a></dd>
				</dl>
				<dl class="clearfix">
					<dt><h3>营销活动</h3></dt>
					<dd><a href="http://www.hxdec.com//index.php/Activi/index/cat_id/25"  target="_blank">全国活动</a></dd>
					<dd><a href="http://www.hxdec.com//index.php/Activi/index/cat_id/26"  target="_blank">分公司活动</a></dd>
				</dl>
