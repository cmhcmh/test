...
@$gd = $_POST['gd'];
@$code = $_POST['code'];
@$content = '中山活动3.26-4.22'.$_POST['content'];
...
if(@$_POST['action'] == 'add47'){
	...
	$sql = "INSERT INTO `tp_message`(`id`, `type`, `name`, `tel`, `content`, `add_time`, `ip`, `hourse`, `is_show`, `company_id`, `be_company_id`, `design_name`, `province_id`, `city_id`, `district_id`, `nums`, `address`, `is_equ`, `is_handle`, `qx`) VALUES ('','1','$name','$tel','$content',".time().",'$ip','$lp','0','76','0',' ','19','234','0','0',' ','1','0','0')";
...
<body style="background:#F63F3B;" >
            ...
            document.searchmyform.submit();     
				...
				<ul class="menu clearfix">
					...
					<li>
						...
						<dl>
						<dd><a href="http://zs.hxdec.com//ppsl/index.php ">品牌介绍</a></dd><dd><a href="http://zs.hxdec.com/index.php/News/index/cat_id/9 ">发展历程</a></dd><dd><a href="http://zs.hxdec.com/index.php/News/index/cat_id/10 ">资质荣誉</a></dd><dd><a href="http://zs.hxdec.com/index.php/News/index/cat_id/11 ">企业动态</a></dd><dd><a href="http://zs.hxdec.com/index.php/News/index/cat_id/12 ">社会公益</a></dd><dd><a href="http://zs.hxdec.com/index.php/News/index/cat_id/13 ">品牌视频</a></dd>						</dl>
					</li>
					<li>
						<h3><a href="http://zs.hxdec.com/index.php/Case/index">装修案例</a></h3>
						<dl>

							<dd><a href="" target="_blank">金马克</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/Case/index">精品案例</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/Gallery/index">案例图库</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/Vr/index">VR实景</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/Hourse/index">热装楼盘</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/Work/index">在建工地</a></dd>
						</dl>
					</li>
					<li>
						<h3><a href="http://zs.hxdec.com/index.php/Design/index">服务团队</a></h3>
						<dl>
							<dd style="display: none"><a href="#">设计研究院</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/Design/index">设计团队</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/Dot/index">服务门店</a></dd>
						</dl>
					</li>
					<li>
						<h3><a href="http://zs.hxdec.com/index.php/Page/index/cat_id/30">服务保障</a></h3>
						<dl>
							<dd><a href="http://zs.hxdec.com//index.php/Page/index/cat_id/30">服务流程</a></dd>
							<dd><a href="#" class="boOrder">在线下单</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/Design/index"  >装修预约</a></dd>
							<dd><a href="http://zs.hxdec.com/index.php/News/index/cat_id/34">装修故事</a></dd>
						</dl>
					</li>
	...
	<div class="main" style="width: 100%;margin: 0px auto;text-align: center;">
		...
		<div style="width:1202px;margin: 0px auto;text-align: right;">
			...
			<img src="images/HZ2_03.png" style="width:70%; margin: 0px auto;text-align: center;"/>
					  ...
					  <div class="swiper-slide"> 
					   <ul id="Tab">
						  <li>
							<ul id="Tab_c">
								<li>
									<a href="http://zs.hxdec.com/index.php/Case/detail/id/14330" target="_blank">
									...
									<div class="clear"></div>
									<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">奕翠园</div>
									</a>
								</li>
								<li>
									<a href="http://zs.hxdec.com/index.php/Case/detail/id/12238" target="_blank">
									...
									<div class="clear"></div>
									<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">万科朗润园</div>
									</a>
								</li>
								<li>
									<a href="http://zs.hxdec.com/index.php/Case/detail/id/14337" target="_blank">
									...
									<div class="clear"></div>
									<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">颐和山庄</div>
									</a>
								</li>
							</ul>
						   </li>
							...
							<ul id="Tab">
							  <li>
								<ul id="Tab_c">
									<li>
										<a href="
http://zs.hxdec.com/index.php/Case/detail/id/1108" target="_blank">
									...
									<p><img src="images/al/ZS-4 (4).png" style="width: 110px;height:104px;"/></p>
										<div class="clear"></div>
										<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">荔园</div>
										</a>
									</li>
									<li>
										<a href="http://zs.hxdec.com/index.php/Case/detail/id/14428" target="_blank">
									...
									<p><img src="images/al/ZS-5 (4).png" style="width: 110px;height:104px;"/></p>
										<div class="clear"></div>
										<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">帝景东方</div>
										</a>
									</li>
									<li>
										<a href="http://zs.hxdec.com/index.php/Case/detail/id/14426" target="_blank">
									...
									<p><img src="images/al/ZS-6 (4).png" style="width: 110px;height:104px;"/></p>
										<div class="clear"></div>
										<div style="background:#fdac83;padding:2%;margin-top:4%;text-align:center;font-size:18px; color:#fff;">建华花园</div>
										</a>
									</li>
								</ul>
							  </li>
	...
	<div style="position:absolute; bottom:400px;z-index:4;text-align:center; margin:0px auto;width: 100%;"><p style="margin:0px auto;text-align:center;margin: 0 auto;width: 1200px;font-size:20px;">本次活动最终解释权归 广东华浔品味装饰集团中山公司 所有</p></div>
...
<div class="foot">
		<div class="layout">
			<div class="ftop clearfix">
				...
				<dl class="clearfix">
					<dt><h3>装修案例</h3></dt>
							<dd><a href="http://zs.hxdec.com//index.php/Case/index"  target="_blank">金马克</a></dd>
							<dd><a href="http://zs.hxdec.com//index.php/Case/index"  target="_blank">精品案例</a></dd>
							<dd><a href="http://zs.hxdec.com//index.php/Gallery/index"  target="_blank">案例图库</a></dd>
							<dd><a href="http://zs.hxdec.com//index.php/Vr/index"  target="_blank">VR实景</a></dd>
							<dd><a href="http://zs.hxdec.com//index.php/Hourse/index"  target="_blank">热装楼盘</a></dd>
							<dd><a href="http://zs.hxdec.com//index.php/Work/index"  target="_blank">在建工地</a></dd>
				</dl>

				<dl class="clearfix">
					<dt><h3>服务团队</h3></dt>
						<dd><a href="http://zs.hxdec.com//index.php/Design/index"  target="_blank">设计团队</a></dd>
						<dd><a href="http://zs.hxdec.com//index.php/Dot/index"  target="_blank">服务门店</a></dd>
				</dl>
				<dl class="clearfix">
					<dt><h3>营销活动</h3></dt>
					<dd><a href="http://zs.hxdec.com//index.php/Activi/index/cat_id/25"  target="_blank">全国活动</a></dd>
					<dd><a href="http://zs.hxdec.com//index.php/Activi/index/cat_id/26"  target="_blank">分公司活动</a></dd>
				</dl>
