...
@$gd = $_POST['gd'];
@$code = $_POST['code'];
@$content = '中山活动手机版33.26-4.22'.$_POST['content'];
...
if(@$_POST['action'] == 'add47'){
	...
	if($r){
	echo "<script>alert('预约成功，请耐心等待客服专员与您联系！');location.href='/zszt/mobile'</script>";die();
	}else{
		var_dump($sql);
		exit();
	}
		...
		<div style="width:100%;">
			<div style="margin:0px auto;background:url(images/hz033.png) no-repeat center top; background-size:100%;width:90%;  height:100%;">
				<ul style="width:100%; display:block; padding-top:9%; padding-bottom:5%;padding-left:2%;">
					<a href="http://zs.hxdec.com/mobile.php/Case/detail/id/1108"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal05.jpg" style="width:98%;"/></li></a>
					<a href="http://zs.hxdec.com/mobile.php/Case/detail/id/14330"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal03.jpg" style="width:98%;"/></li></a>
					<div class="clear"></div>
					<a href="http://zs.hxdec.com/mobile.php/Case/detail/id/12238"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal12.jpg" style="width:98%;"/></li></a>
					<a href="http://zs.hxdec.com/mobile.php/Case/detail/id/14428"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal09.jpg" style="width:98%;"/></li></a>
					<div class="clear"></div>
				</ul>
			</div>
		</div>
		<div style="width:100%; margin-bottom:6%;margin-top:6%;position: relative; z-index:99;">
			<div style="margin:0px auto;background:url(images/hz007.jpg) no-repeat center top; background-size:100%;width:90%;  height:100%;padding-bottom:15%;">
				<ul style="width:100%; display:block;  padding-left:0%;">
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/ZS手机_11.jpg" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/ZS手机_13.jpg" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/ZS手机_15.jpg" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/ZS手机_17.jpg" style="width:99%;"/></li></a>
					<div class="clear"></div>
				</ul>
				<ul style="width:100%; display:block;  padding-left:0%;">
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/ZS手机_29.jpg" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/ZS手机_31.jpg" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/ZS手机_33.jpg" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/ZS手机_35.jpg" style="width:99%;"/></li></a>
					<div class="clear"></div>
				</ul>
				<div style="background:#F92424; color:#fff;font-size:0.1rem;width:95%; margin:0px auto; line-height:0.6rem;">
