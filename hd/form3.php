...
#div4 label{font-size:16px;color:#000;}	 
#div4 input{border:1px gray solid;font-size:16px;}	 
.mx{width:300px;line-height:35px;}
#div4 form{padding:5px 5px; margin:0px auto; margin-left:12%; }
</style>
<script>
function OpenDiv3(){
...
<a style="margin-left:2%;" href="javascript:CloseDiv3();"><input style="font-size:14px;padding:3px;margin-top:2%;" type="button" name="guanbi" value="关闭" /></a>
</form>
</div>