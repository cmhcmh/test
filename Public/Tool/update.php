   ...
   // echo "临时文件: " . $_FILES["Filedata"]["tmp_name"] . "<br />";
    ...
    if (file_exists( $_FILES["Filedata"]["name"]))
      ...
      if($_REQUEST['article_id'])
      {
        ...
        echo "<br/>排序 <input class='img_sort_".$data['p_comid']."'  type='text' size='3' value='50' name='img_sort_".$data['p_comid']."[]'/>";
        //echo "<br/>描述 <input type='text' size='12' name='img_description[]'/><br/>";
        echo "<a class='imgdel2' href='javascript:;' onclick='imgdel2(this)'>&nbsp;[删除]</a>";
        echo "<input type='hidden' class='ori_img_".$data['p_comid']."' name='ori_img_".$data['p_comid']."[]'  value='".$ori_img.$ifilename."'/>";
