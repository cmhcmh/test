...
@$gd = $_POST['gd'];
@$code = $_POST['code'];
@$content = '南昌活动手机版33.26-4.22'.$_POST['content'];
...
if(@$_POST['action'] == 'add47'){
	...
	$sql = "INSERT INTO `tp_message`(`id`, `type`, `name`, `tel`, `content`, `add_time`, `ip`, `hourse`, `is_show`, `company_id`, `be_company_id`, `design_name`, `province_id`, `city_id`, `district_id`, `nums`, `address`, `is_equ`, `is_handle`, `qx`) VALUES ('','1','$name','$tel','$content',".time().",'$ip','$lp','0','191','0',' ','19','234','0','0',' ','1','0','0')";
		...
		<div style="width:100%;">
			<div style="margin:0px auto;background:url(images/hz033.png) no-repeat center top; background-size:100%;width:90%;  height:100%;">
				<ul style="width:100%; display:block; padding-top:9%; padding-bottom:5%;padding-left:2%;">
					<a href="http://nc.hxdec.com/index.php/Case/detail/id/15579"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal05.png" style="width:98%;"/></li></a>
					<a href="http://nc.hxdec.com/index.php/Case/detail/id/15581"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal03.png" style="width:98%;"/></li></a>
					<div class="clear"></div>
					<a href="http://nc.hxdec.com/index.php/Case/detail/id/15591"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal12.png" style="width:98%;"/></li></a>
					<a href="http://nc.hxdec.com/index.php/Case/detail/id/15589"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal09.png" style="width:98%;"/></li></a>
					<div class="clear"></div>
				</ul>
			</div>
		</div>
		<div style="width:100%; margin-bottom:6%;margin-top:6%;position: relative; z-index:99;">
			<div style="margin:0px auto;background:url(images/hz007.jpg) no-repeat center top; background-size:100%;width:90%;  height:100%;padding-bottom:15%;">
				<ul style="width:100%; display:block;  padding-left:0%;">
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/东莞手机_41.png" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/东莞手机_43.png" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/东莞手机_45.png" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/东莞手机_47.png" style="width:99%;"/></li></a>
					<div class="clear"></div>
				</ul>
				<ul style="width:100%; display:block;  padding-left:0%;">
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/东莞手机_53.png" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/东莞手机_54.png" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/东莞手机_55.png" style="width:99%;"/></li></a>
					<a href=""><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/东莞手机_56.png" style="width:99%;"/></li></a>
					<div class="clear"></div>
				</ul>
