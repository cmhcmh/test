...
@$gd = $_POST['gd'];
@$code = $_POST['code'];
@$content = '无锡活动手机版3.26-4.22'.$_POST['content'];
...
if(@$_POST['action'] == 'add47'){
	...
	$sql = "INSERT INTO `tp_message`(`id`, `type`, `name`, `tel`, `content`, `add_time`, `ip`, `hourse`, `is_show`, `company_id`, `be_company_id`, `design_name`, `province_id`, `city_id`, `district_id`, `nums`, `address`, `is_equ`, `is_handle`, `qx`) VALUES ('','1','$name','$tel','$content',".time().",'$ip','$lp','0','147','0',' ','19','234','0','0',' ','1','0','0')";
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?80f384e7aabb3b12f19958c3264ff344";
		...
		<div style="width:100%;">
			<div style="margin:0px auto;background:url(images/hz033.png) no-repeat center top; background-size:100%;width:90%;  height:100%;">
				<ul style="width:100%; display:block; padding-top:9%; padding-bottom:5%;padding-left:2%;">
					<a href="#"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal05.jpg" style="width:98%;"/></li></a>
					<a href="#"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal03.jpg" style="width:98%;"/></li></a>
					<div class="clear"></div>
					<a href="#"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal12.jpg" style="width:98%;"/></li></a>
					<a href="#"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal09.jpg" style="width:98%;"/></li></a>
					<div class="clear"></div>
				</ul>
			</div>
		</div>
