...
@$gd = $_POST['gd'];
@$code = $_POST['code'];
@$content = '惠州活动手机版33.26-4.22'.$_POST['content'];
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?0fee4a5710b1e6bf0aefa7dd5c45145b";
...
(function() {
  var hm = document.createElement("script");
  hm.src = "https://hm.baidu.com/hm.js?04aabf321c0bc17b6a28e00646eb34df";
  var s = document.getElementsByTagName("script")[0]; 
  s.parentNode.insertBefore(hm, s);
})();
</script>
		...
		<div style="width:100%;">
			<div style="margin:0px auto;background:url(images/hz033.png) no-repeat center top; background-size:100%;width:90%;  height:100%;">
				<ul style="width:100%; display:block; padding-top:9%; padding-bottom:5%;padding-left:2%;">
					<a href="http://huizhou.hxdec.com/mobile.php/Case/detail/id/13915"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal05.png" style="width:98%;"/></li></a>
					<a href="http://huizhou.hxdec.com/mobile.php/Case/detail/id/13952"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal03.png" style="width:98%;"/></li></a>
					<div class="clear"></div>
					<a href="http://huizhou.hxdec.com/mobile.php/Case/detail/id/13955"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal12.png" style="width:98%;"/></li></a>
					<a href="http://huizhou.hxdec.com/mobile.php/Case/detail/id/13916"><li style="width:45%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzal09.png" style="width:98%;"/></li></a>
					<div class="clear"></div>
				</ul>
			</div>
		</div>
		<div style="width:100%; margin-bottom:6%;margin-top:6%;position: relative; z-index:99;">
			<div style="margin:0px auto;background:url(images/hz007.png) no-repeat center top; background-size:100%;width:90%;  height:100%;padding-bottom:15%;">
				<ul style="width:100%; display:block;  padding-left:0%;">
					<a href="http://huizhou.hxdec.com/mobile.php/Design/detail/id/13812"><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzsj03.png" style="width:99%;"/></li></a>
					<a href="http://huizhou.hxdec.com/mobile.php/Design/detail/id/13810"><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzsj05.png" style="width:99%;"/></li></a>
					<a href="http://huizhou.hxdec.com/mobile.php/Design/detail/id/13814"><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzsj07.png" style="width:99%;"/></li></a>
					<a href="http://huizhou.hxdec.com/mobile.php/Design/detail/id/13823"><li style="width:21%; display:block; float:left; margin:2%; overflow: hidden;"><img src="images/hzsj09.png" style="width:99%;"/></li></a>
					<div class="clear"></div>
				</ul>
