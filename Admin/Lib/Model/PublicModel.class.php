...
ini_set('session.gc_maxlifetime',3);
		...
		//session(array('admin_id'=>$user_id,'expire'=>10));
		//session(array('admin_name'=>$username,'expire'=>10));
		//session(array('action_list'=>$action_list,'expire'=>10));
		//session(array('last_check'=>$last_time,'expire'=>10));
