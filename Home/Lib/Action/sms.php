...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIgyRdq1YP6mpt"; // AccessKeyId

        $accessKeySecret = "XrCIILpW4S28yikwTgYfniqlkVe78Z"; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers("18316875852");

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("华浔品味装饰集团");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_148075699");
     ...
     * @return stdClass
     */
    public static function sendBatchSms($phone, $data) {
//dump($data);
        // 初始化SendSmsRequest实例用于设置发送短信的参数
    ...
    public static function querySendDetails() {
        ...
        // 必填，短信接收号码
        $request->setPhoneNumber("18316875852");
